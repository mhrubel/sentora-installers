...
SENTORA_INSTALLER_VERSION="1.0.4"
SENTORA_CORE_VERSION="1.0.4"
SENTORA_PRECONF_VERSION="1.0.4"
...
# Get latest sentora
while true; do
    wget -nv -O sentora_core.zip https://github.com/mhrubel/sentora-core/archive/$SENTORA_CORE_VERSION.zip
...
#--- Install preconfig
while true; do
    wget -nv -O sentora_preconfig.zip https://github.com/mhrubel/sentora-installers/archive/$SENTORA_PRECONF_VERSION.zip
